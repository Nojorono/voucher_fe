...
import DataTableComponent from '../../components/Tables/DataTableScript';
    ...
    const columns = [
        {
            ...
            sortable: true,
            cell: (row: any) => <div className="text-xl">{row.name}</div>, // Styling dengan kelas CSS dan ukuran teks diperbesar
        },
        {
            name: 'Telepon',
            selector: (row: any) => row.phone_number,
            sortable: true,
            cell: (row: any) => <div className="text-xl">{row.phone_number}</div>, // Styling dengan kelas CSS
        },
    ];

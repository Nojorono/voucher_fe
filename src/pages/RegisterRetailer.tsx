...
const RegisterRetailer: React.FC = () => {
    ...
    const postRetailerData = async (data: IFormInput) => {
        try {
            ...
            const formFields = {
                ...
                photo_remarks: data.photo_remarks,
            };
            ...
            if (!response.ok) {
                ...
                if (response.status === 400) {
                    showErrorToast(`${result.non_field_errors}`);
    ...
    const fields: { name: keyof IFormInput; label: string; required: boolean; type?: string }[] = [
        { name: 'ws_name', label: 'Wholesale Name', required: true },
        { name: 'username', label: 'Owner Name', required: true },
        ...
        // { name: 'photo_remarks', label: 'Photo Remarks', required: false },
    ];
            ...
            <div className="flex flex-wrap items-center">
                ...
                <div className="w-full xl:w-1/2 p-10">
                    <div className="p-10">
                        ...
                        <h2 className="text-2xl font-bold mb-5">Register Retailer</h2>

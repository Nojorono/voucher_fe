                ...
                <div className="col-span-1 md:col-span-2">
                    <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-2" role="alert">
                        ...
                        <span className="block sm:inline">
                            Kode Voucher hanya akan dikirimkan setelah pihak Admin sudah melakukan verifikasi dan akan dikirimkan melalui WhatsApp dari nomor <b>081220199495</b> saja.
                        </span>
